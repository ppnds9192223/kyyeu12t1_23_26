document.addEventListener('DOMContentLoaded', () => {
    ...
    const members = [
        ...
        { name: 'Trương Hoàng Khang', nickname: 'No nickname', quote: 'Sống trọn từng phút giây.', img: 'style/img/ThanhVien/LeChi.jpg', hobbies: 'Vẽ tranh, Nghe nhạc', message: 'Chúc cả lớp thành công!' },
        { name: 'Nguyễn Tố Hữu', nickname: 'No nickname', quote: 'Luôn là chính mình.', img: 'style/img/ThanhVien/HoangDung.jpg', hobbies: 'Nấu ăn, Chơi game', message: 'Thương lớp mình lắm.' },
        { name: 'Trần Triệu Phát', nickname: 'No nickname', quote: 'Ngày mai sẽ tốt hơn.', img: 'style/img/ThanhVien/DoHai.jpg', hobbies: 'Cầu lông, Xem phim', message: 'Đừng quên mình nhé.' },
        { name: 'Trần Thị Như Ý', nickname: 'No nickname', quote: 'Cứ đi rồi sẽ đến.', img: 'style/img/ThanhVien/BaoThy.jpg', hobbies: 'Đọc sách, Ca hát', message: 'Chào thân ái!' },
        { name: 'Nguyễn Thị Tuyết Mai', nickname: 'No nickname', quote: 'Yêu đời, yêu người.', img: 'style/img/ThanhVien/AnBinh.jpg', hobbies: 'Du lịch, Chụp ảnh', message: 'Yêu cả nhà.' },
        { name: 'Phan Đình Phong', nickname: 'Gió bão', quote: 'Ăn là chân ái.', img: 'style/img/ThanhVien/LinhHa.jpg', hobbies: 'Du lịch, xem phim', message: 'Cố lên lứa 2007!' },
        { name: 'Võ Chế Thiện', nickname: 'No nickname', quote: 'Đẳng cấp là mãi mãi.', img: 'style/img/ThanhVien/MinhBao.jpg', hobbies: 'Xem phim, chơi game', message: 'Tạm biệt nhé!' },
        { name: 'Lê An Thịnh', nickname: 'Ngọ', quote: 'Cứ chill thôi', img: 'style/img/ThanhVien/ThanhThai.jpg', hobbies: 'Chơi game, đi chơi cùng bạn bè', message: 'Nhớ mọi người.' },
        { name: 'Lê Cẩm Trình', nickname: 'No nickname', quote: 'Vui vẻ không quạo.', img: 'style/img/ThanhVien/TuanKiet.jpg', hobbies: 'Quay phim, Nghe nhạc', message: 'Cháy hết mình nào.' },
        { name: 'Lê Thị Tuyết Minh', nickname: 'No nickname', quote: 'Trùm trường là đây.', img: 'style/img/ThanhVien/MinhQuan.jpg', hobbies: 'Đọc sách, Chơi game', message: 'Hẹn ngày tái ngộ.' },
        { name: 'Nguyễn Quốc Việt', nickname: 'No nickname', quote: 'Nhẹ nhàng và tinh tế.', img: 'style/img/ThanhVien/NgocTuan.jpg', hobbies: 'Du lịch, chụp ảnh', message: 'Chúc mọi điều tốt đẹp.' },
        { name: 'Thái Hoàng Huy', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Minh Nhựt', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trần Thiện Nhân', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Quốc Bảo', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Dương Gia Hy', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Thái Hà', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Kim Ngân', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Ngô Thị Ngọc Linh', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Châu Hồng Nhi', nickname: 'Lớp trưởng', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trần Đình Hòa', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trần Tất Đạt', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Thị Bảo Trân', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Ngọc Thảo Nguyên', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Thị Ngọc Ri', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Thị Xuân Hương', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Phước Hải', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Khắc Huy', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Dương Diễm Huyền', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Phương Mai', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trần Minh Khang', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Phạm Tấn Phát', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Thị Trâm Anh', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trần Thị Quỳnh Như', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Phạm Anh Khôi', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Huỳnh Quốc Duy', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Anh Hào', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Thị Quỳnh Như', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trần Thị Thanh Tuyền', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Trương Tấn Phát', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Nguyễn Thị Kim Ngân', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Lê Duy Khánh', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' } ,
        { name: 'Phạm Khánh Hưng', nickname: 'No nickname', quote: 'Nỗi buồn cũng đẹp.', img: 'style/img/ThanhVien/HongDung.jpg', hobbies: 'Viết lách, Đi bộ', message: 'Lớp mình là nhất.' }
    ];
